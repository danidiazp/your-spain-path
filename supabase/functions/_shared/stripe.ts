// Cliente Stripe que enruta todas las llamadas a través del connector gateway de Lovable.
// NO usar new Stripe(secret) directamente: el "secret" disponible es un identificador
// del gateway, no la API key real de Stripe.
